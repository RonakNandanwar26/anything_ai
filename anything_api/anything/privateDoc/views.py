...
class Summarizedoc(APIView):
    def post(self, request):
        try:
            ...
            return Response({'status_code':400,'message':'Rate limit reached for gpt-3.5-turbo','data':""},status=HTTP_422_UNPROCESSABLE_ENTITY)
        except Exception:
            return Response({'status_code':400,'message':'Something went wrong...','data':""},status=HTTP_422_UNPROCESSABLE_ENTITY)
